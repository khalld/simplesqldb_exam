...
<body>
	...
	<article class="panel">
		<div class="panel__copy">
			<h2 class="panel__copy__title">Grazie!</h2>
			<!--<p class="panel__copy__meta">Elenco delle <a href="">visite</a></p>--->
			<p>Ogni tuo contributo monetario ci permetterà di acquistare cibo e medicinali per i nostri ospiti, ma anche
				di assicurare loro una continua assistenza veterinaria, di regalare alle loro lunghe giornate in canile attimi di svago con palline,
				giochi gommosi e piscine in plastica per l’estate e, cosa di importanza fondamentale, di portare a termine i lavori di edificazione del
				nuovo canile. <br><br><i>Le ultime donazioni</i></p>
		...
		<?php
				...
				$query = "SELECT data, descrizione FROM donazione ";
