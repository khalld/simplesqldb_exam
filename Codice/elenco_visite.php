...
<body>
	...
	<article class="panel">
		<div class="panel__copy_grande">
			<h2 class="panel__copy__title">Elenco visite</h2>
	...
	<?php
			...
			$query = "SELECT visita.data, veterinario.cognome, cane.nome, diagnosi.descrizione FROM visita, diagnosi, veterinario, cane
								WHERE visita.id_visita=diagnosi.id_visita AND cane.id_cane=visita.id_cane AND visita.id_veterinario=veterinario.id_veterinario";
