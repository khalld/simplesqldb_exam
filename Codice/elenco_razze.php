...
<body>
	...
	<header class="header clearfix">
		...
		<ul class="header__menu animate">
			...
			<li class="header__menu__item"><a href="contact_form.php">Item</a></li>
		</ul>
	</header>
	...
	<article class="panel">
		<div class="panel__copy_grande">
			<h2 class="panel__copy__title">Elenco razze</h2>
			<p class="panel__copy__meta">Indeciso sull'adozione? Chiarisci ogni dubbio cercando il cucciolo più adatto a te</p>
	...
	<?php
			...
			$query = "SELECT nome_razza, longevita, taglia, altezza, peso, descrizione FROM razza";
		  ...
		  // controllo sul numero dei record coinvolti
			...
			{
				echo '<tr>';
				echo '<td>' . $row['nome_razza'] . '</td>';
				echo '<td>' . $row['longevita'] . '</td>';
