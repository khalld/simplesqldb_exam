...
<body>
	...
	<article class="panel">
		<div class="panel__copy">
			<h2 class="panel__copy__title">Elenco adozioni</h2>
...
<?php
		...
		$query = "SELECT adozione.data, cane.nome AS nomeC, cittadino.nome AS nomeCitt FROM adozione, cane, cittadino
							WHERE adozione.id_cane=cane.id_cane AND adozione.codFiscale_cittadino=cittadino.cod_fiscale
							ORDER BY adozione.data DESC";
