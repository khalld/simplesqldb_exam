...
<body>
	...
	<article class="panel">
		<div class="panel__copy">
			<h2 class="panel__copy__title">Il nostro staff</h2>
			<p class="panel__copy__meta">Per qualsiasi informazione non esitare a contattarci!</p>
...
<?php
		...
		$query = "SELECT nome, cognome, data_nascita, email FROM volontario";
